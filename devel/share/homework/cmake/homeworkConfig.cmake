...
if("TRUE" STREQUAL "TRUE")
  set(homework_SOURCE_PREFIX /home/pi/Program/RobotSystem/source/RobotSystem2017HW-02/src/homework)
  set(homework_DEVEL_PREFIX /home/pi/Program/RobotSystem/source/RobotSystem2017HW-02/devel)
  set(homework_INSTALL_PREFIX "")
  set(homework_PREFIX ${homework_DEVEL_PREFIX})
else()
  set(homework_SOURCE_PREFIX "")
  set(homework_DEVEL_PREFIX "")
  set(homework_INSTALL_PREFIX /home/pi/Program/RobotSystem/source/RobotSystem2017HW-02/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'homework' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/Program/RobotSystem/source/RobotSystem2017HW-02/src/homework/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/Program/RobotSystem/source/RobotSystem2017HW-02/devel/lib;/home/pi/Program/RobotSystem/source/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
